...
export declare type PetsCollectionOverridesProps = {
    PetsCollection?: PrimitiveOverrideProps<CollectionProps>;
...
export declare type PetsCollectionProps = React.PropsWithChildren<Partial<CollectionProps<any>> & {
    ...
    overrides?: PetsCollectionOverridesProps | undefined | null;
}>;
